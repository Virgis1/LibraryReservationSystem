    ...
    <LayoutTemplate>
        <table class="datagrid-custom">
            <thead style="background-color: #004080; color: white; font-weight: bold;">
                <tr>
                    <th>
                        <asp:LinkButton ID="lnkSortTitle" runat="server" CommandName="Sort" CommandArgument="Title">Pavadinimas</asp:LinkButton>
                    </th>
                    <th>
                        <asp:LinkButton ID="lnkSortAuthor" runat="server" CommandName="Sort" CommandArgument="Author">Autorius</asp:LinkButton>
                    </th>
                    <th>
                        <asp:LinkButton ID="lnkSortYear" runat="server" CommandName="Sort" CommandArgument="Year">Metai</asp:LinkButton>
                    </th>
                </tr>
            </thead>
            <tbody>
